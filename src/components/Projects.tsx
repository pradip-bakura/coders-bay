...
const Projects = () => {
  const projects = [
    ...
    // {
    //   title: "Sights Management System",
    //   description: "A location-based management system for tracking and organizing points of interest with geospatial data integration.",
    //   icon: MapPin,
    //   technologies: ["JavaScript", "HTML/CSS", "MySQL", "Java"],
    //   features: [
